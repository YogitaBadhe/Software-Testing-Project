...
//-------------------------------Module 1 : Elements------------------------------------------------------
		...
		w.findElement(By.id("userEmail")).sendKeys("ybadhe0990@gmail.com");
...
//----------------------------------------------Module 6: Book store---------------------------------------------------------
				...
				//w.findElement(By.xpath("//*[@id=\"firstname\"]")).sendKeys("pooja");
				//w.findElement(By.xpath("//*[@id=\"lastname\"]")).sendKeys("bhosale");
				//w.findElement(By.xpath("//*[@id=\"userName\"]")).sendKeys("poojabhosale123");
				//w.findElement(By.xpath("//*[@id=\"password\"]")).sendKeys("poojabhosale@123");
				...
				w.findElement(By.xpath("//*[@id=\"userName\"]")).sendKeys("YogitaBadhe");
				w.findElement(By.xpath("//*[@id=\"password\"]")).sendKeys("YogitaBadhe@123");
